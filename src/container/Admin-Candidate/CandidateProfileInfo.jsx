...
const CandidateProfileInfo = () => {
  ...
  useEffect(() => {
    const fetchCandidateDetails = async () => {
      try {
        const response = await axios.get(`http://localhost:5000/api/userprofile/admin/user-profile-with-applications/${userId}`, {
          headers: {
  ...
  const { address, experience, education, profileImage, firstName, lastName, skills, userId: user } = userProfile;

  return (
    <div className="container-fluid my-2 p-sm-5">
      <div className="row">
        <div className="col-12 text-center p-5">
          <img src={`http://localhost:5000/uploads/${profileImage.split('\\').pop()}`} alt="Profile" className="profile-image"/>
          <h2 className="section-title">Personal Info</h2>
          <div className="row">
            <div className="col-md-6">
              <div className="info-item">
                <label>First Name:</label>
                <input className="text-color" type="text" value={firstName} disabled />
              </div>
              <div className="info-item">
                <label>Email:</label>
                <input className="text-color" type="email" value={user.email} disabled />
              </div>
            </div>
            <div className="col-md-6">
              <div className="info-item">
                <label>Last Name:</label>
                <input className="text-color" type="text" value={lastName} disabled />
              </div>
              <div className="info-item">
                <label>Skills:</label>
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="info-item">
                <label>Company:</label>
                <input className="text-color" type="text" value={experience.company} disabled />
              </div>
              <div className="info-item">
                <label>End Date:</label>
                <input className="text-color" type="text" value={new Date(experience.endDate).toLocaleDateString()} disabled />
              </div>
            </div>
            <div className="col-md-6">
              <div className="info-item">
                <label>Job Description:</label>
                <input className="text-color" type="text" value={experience.jobDescription} disabled />
              </div>
              <div className="info-item">
                <label>Start Date:</label>
                <input className="text-color" type="text" value={new Date(experience.startDate).toLocaleDateString()} disabled />
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="info-item">
                ...
                <input className="text-color" type="text" value={education.qualification} disabled />
              </div>
            </div>
            <div className="col-md-6">
              <div className="info-item">
                <label>Institute:</label>
                <input className="text-color" type="text" value={education.institute} disabled />
              </div>
              <div className="info-item">
                <label>End Date:</label>
                <input className="text-color" type="text" value={new Date(education.endDate).toLocaleDateString()} disabled />
              </div>
            </div>
          </div>
