  ...
  return (
    <BootstrapNavbar expand="lg" style={{ backgroundColor: primaryColor, position: 'sticky', top: '0', width: '100%', zIndex: '999' }} >
      ...
      <BootstrapNavbar.Collapse id="basic-navbar-nav" style={{ justifyContent: 'right' }}>
        ...
        <Link to={role === 'candidate' ? "/candidate_profile" : "/employer_profile"} style={{ color: primaryFontColor, marginRight: '10px', height: '60px', width: '60px', display: 'flex', alignItems: 'center' }}>
          <img src={profileImage || defaultProfileImage} alt="Profile" style={{ height: '60px', width: '60px', borderRadius: '50%' }} />
        </Link>
